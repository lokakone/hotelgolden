        ...
        <div class="col-12">
          ...
          <div class="card card-info card-outline">
            ...
            <div class="card-header">
              ...
              <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#crearCategoria">CREAR NUEVA HABITACION</button>
    ...
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header bg-info">
          <h4 class="modal-title">CREAR HABITACION</h4>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group my-2">
              ...
              <div class="btn btn-default btn-file">
                  ...
                  <i class="fas fa-paperclip"></i> Adjuntar Imagen de la habitacion
            ...
            <p>ESCRIBA LA DESCRIPCION DE LA HABITACION:</p>
          ...
          <p>CARACTERISTICAS DE LA HABITACION:</p>
