...
class ModeloCategorias{
	...
	static public function mdlRegistroCategoria($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(tipo, img, descripcion, incluye,  continental_alta, continental_baja, americano_alta, americano_baja) VALUES (:tipo, :img, :descripcion, :incluye, :continental_alta, :continental_baja, :americano_alta, :americano_baja)");
	...
	static public function mdlEditarCategoria($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET tipo = :tipo, img = :img, descripcion = :descripcion, incluye = :incluye, continental_alta = :continental_alta, continental_baja = :continental_baja, americano_alta = :americano_alta, americano_baja = :americano_baja  WHERE id = :id");
